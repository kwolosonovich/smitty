...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'postgresql:///smithsonian')
...
def homepage():
   ...
   formatted_images = search(search_terms=None, dev=DEV, images_per_row=9, max_rows=1, max_results=9, is_homepage=True)
